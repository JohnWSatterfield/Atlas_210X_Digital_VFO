 ...
 */
  /*
  * for 128x160 display change yW in display.h to 160 and
  * change line 137 of display.cpp SPI.write(0x9F);  0x9F is 159 0x7F is 127
  * for 128x128 display change Yw in display.h to 128 and 
  * change Line 137 of display.cpp SPI.write(0x7F);  0x9F is 159 0x7F is 127
 */
...
#define SCLK  18 // SPI clock pin (SCL)
#define SDI -1 // MISO(master input slave output) not using
#define SDO 23 // MOSI(master output slave input) pin (SDA)
#define CS  5 // Chip Select pin
#define DC  15 // Data/Command pin
#define RST -1 // Reset pin (RES)
...
void display_init(void){  
  ...
  SPI.write(0x00); SPI.write(0x00); SPI.write(0x00); SPI.write(0x9F);  //159 is 0x9F & 127 is 0x7F
