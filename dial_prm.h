...
char f_FONT = 0;   // Font   0, 1, or 2  12, 14 or 16
char f_rev = 1;   // Increasing Direction of dial rotation   0: CW / 1: CCW
...
//ダイアル表示エリア------------------------------------------------------------
int D_height = 71;   // Display position

//ダイアル半径------------------------------------------------------------------
int D_R = 160;   //Dial radius (if 45000, Linear scale)

//メイン，サブダイアルの間隔----------------------------------------------------
int Dial_space = 26;   // Space bitween Main and Sub Dial

//目盛り間隔--------------------------------------------------------------------
int tick_pitch_main = 50; // Main Tick Pitch
int tick_pitch     = 50;  // Sub Tick Pitch
...
int tick_main5 = 8;  // Length of Main Tick(5)
int tick_main10 = 10; // Length of Main Tick(10)

//目盛りの長さ(sub)-------------------------------------------------------------
int tick1 = 4;    // Length of Sub Tick(1)
int tick5 = 8;   // Length of Sub Tick(5)
int tick10 = 10;  // Length of Sub Tick(10)

//目盛り・数字間のスペース------------------------------------------------------
int TNCL_main = 10;  // Space bitween Number and Tick (Main)
int TNCL = 10;      // Space bitween Number and Tick (Sub)
